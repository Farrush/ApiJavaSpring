...
public class DbService {
    ...
    public void criarDadosMySQL() {
        ...
        Usuario usu1 = usuarioRepository.findById(1L).orElse(null);
        Usuario usu2 = usuarioRepository.findById(2L).orElse(null);
        Usuario usu3 = usuarioRepository.findById(14L).orElse(null);
